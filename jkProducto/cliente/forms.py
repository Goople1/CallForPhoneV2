...
class ClienteForm(forms.Form):
	...
	correo = forms.EmailField(max_length= 200, label='Correo:',widget=forms.EmailInput(attrs={'class':'fillin validated form-control','name':'txtCorreo','id':'txtCorreo','placeholder':'Correo','spellcheck':'false','title':'Correo'})) 
